 ...
 * - Reply text is validated in memory, sent to Meta, and recorded in a
 *   content-free operational ledger. Eligible canary text is isolated in a
 *   separate backend-only, short-retention record.
 */
