...
const T = {
  ...
  deptRows: {
    // Real Hemas Hospitals service lines (hemashospitals.com).
    en: [
      { id: "dept_general", title: "General Consultation", description: "Specialist channelling" },
      { id: "dept_cardiology", title: "Cardiology", description: "Heart health — both hospitals" },
      { id: "dept_ortho", title: "Orthopaedics", description: "Bones, joints and surgery" },
      { id: "dept_gyn", title: "Gynae & Obstetrics", description: "Women's care & baby delivery" },
      { id: "dept_urology", title: "Urology & Kidney", description: "Urology and kidney care" },
      { id: "dept_gastro", title: "Gastroenterology", description: "Endoscopy & colonoscopy" },
      { id: "dept_eye", title: "Eye Care", description: "Eye care centre — Wattala" },
      { id: "dept_physio", title: "Physiotherapy", description: "Rehabilitation centres" },
    ],
    si: [
      { id: "dept_general", title: "සාමාන්‍ය උපදේශන", description: "විශේෂඥ චැනලින්" },
      { id: "dept_cardiology", title: "හෘද රෝග", description: "හෘද සෞඛ්‍යය" },
      { id: "dept_ortho", title: "අස්ථි රෝග", description: "අස්ථි සහ සන්ධි සත්කාර" },
      { id: "dept_gyn", title: "නාරිවේද / ප්‍රසව", description: "කාන්තා සත්කාර සහ දරු උපත්" },
      { id: "dept_urology", title: "මුත්‍රා හා වකුගඩු", description: "වකුගඩු සත්කාර" },
      { id: "dept_gastro", title: "ආමාශ ආන්ත්‍ර", description: "එන්ඩොස්කොපි පරීක්ෂණ" },
      { id: "dept_eye", title: "අක්ෂි සත්කාර", description: "අක්ෂි මධ්‍යස්ථානය — වත්තල" },
      { id: "dept_physio", title: "භෞත චිකිත්සාව", description: "පුනරුත්ථාපන සේවා" },
    ],
    ta: [
      { id: "dept_general", title: "பொது ஆலோசனை", description: "நிபுணர் சேனலிங்" },
      { id: "dept_cardiology", title: "இதயவியல்", description: "இதய ஆரோக்கியம்" },
      { id: "dept_ortho", title: "எலும்பியல்", description: "எலும்பு மற்றும் மூட்டு" },
      { id: "dept_gyn", title: "மகப்பேறியல்", description: "பெண்கள் நலம் & பிரசவம்" },
      { id: "dept_urology", title: "சிறுநீரக சிகிச்சை", description: "சிறுநீரகப் பராமரிப்பு" },
      { id: "dept_gastro", title: "இரைப்பை குடல்", description: "எண்டோஸ்கோபி பரிசோதனை" },
      { id: "dept_eye", title: "கண் பராமரிப்பு", description: "கண் மையம் — வத்தளை" },
      { id: "dept_physio", title: "பிசியோதெரபி", description: "மறுவாழ்வு சேவைகள்" },
    ],
  },
  ...
  clinic: {
    en: "🏥 Hemas Hospitals — Sri Lanka's first internationally accredited hospital chain\n\n📍 Wattala — 389, Negombo Road\n📍 Thalawathugoda — 647/2a, Pannipitiya Road (60-bed)\n\n📞 Hotline & emergencies: 0117 888 888\n🌐 hemashealth.com · Hemas Health app\n\n(Governed pilot demo.)\n\nReply MENU for more options.",
    si: "🏥 හෙමාස් රෝහල් — ශ්‍රී ලංකාවේ ප්‍රථම ජාත්‍යන්තර ප්‍රතීතන රෝහල් ජාලය\n\n📍 වත්තල — 389, මීගමු පාර\n📍 තලවතුගොඩ — 647/2a, පන්නිපිටිය පාර\n\n📞 ක්ෂණික ඇමතුම් සහ හදිසි: 0117 888 888\n🌐 hemashealth.com · Hemas Health යෙදුම\n\n(පාලිත ආදර්ශන සේවාවකි.)\n\nතවත් විකල්ප සඳහා MENU ලියන්න.",
    ta: "🏥 ஹேமாஸ் மருத்துவமனைகள் — இலங்கையின் முதல் சர்வதேச அங்கீகாரம் பெற்ற மருத்துவமனை வலையமைப்பு\n\n📍 வத்தளை — 389, நீர்கொழும்பு வீதி\n📍 தலவத்துகொட — 647/2a, பன்னிபிட்டிய வீதி\n\n📞 விரைவு அழைப்பு & அவசரம்: 0117 888 888\n🌐 hemashealth.com · Hemas Health செயலி\n\n(நிர்வகிக்கப்பட்ட மாதிரி சேவை.)\n\nமேலும் விருப்பங்களுக்கு MENU என அனுப்பவும்.",
  },
  staff: {
